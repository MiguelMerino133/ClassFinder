...
public class GUILugar {
    ...
    public Lugar registrar() {
        ...
        Lugar nuevoLugar = new Edificio(nombre, descripcion, numeroPisos, ubicacion);
        if (universidad.crearLugar(nuevoLugar)) {
            System.out.println("Lugar creado exitosamente con ID: " + nuevoLugar.getIdLugar());
            return nuevoLugar;
        } else {
            System.out.println("Error: No se pudo crear el lugar, posible duplicado.");
            return null;
        }
    }
