...
public class Usuario {
    ...
    public Usuario(String nombre, String contrasena, String cedulaIdentidad, String correo, Rol rol) {
        this.idUsuario = PREFIJO + String.format("%03d", contadorUsuarios++);
        setNombre(nombre);
    ...
    public boolean equals(Object o) {
        ...
        return nombre.equalsIgnoreCase(usuario.nombre) && cedulaIdentidad.equals(usuario.cedulaIdentidad);
    }

    @Override
    public int hashCode() {
        int result = nombre.toLowerCase().hashCode();
        result = 31 * result + cedulaIdentidad.hashCode();
        return result;
    }
